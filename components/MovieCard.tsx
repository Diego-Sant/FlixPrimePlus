...
const MovieCard: React.FC<MovieCardProps> = ({data}) => {
    ...
    return (
        <div className="group col-span relative lg:h-[11vw] md:h-[15vw] h-[20vw] mb-5 xl:mb-36 lg:mb-20" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
            ...
            <div className="opacity-0 absolute top-0 transition duration-200 z-30 invisible w-[25vw] h-[20vw] sm:visible delay-300 scale-0 group-hover:scale-110 group-hover:-translate-y-[6.5vw] group-hover:translate-x-[2.7vw] group-hover:opacity-100">
                { data?.videoUrl ? 
