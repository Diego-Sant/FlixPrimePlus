...
const Navbar  = () => {
    ...
    return (
        <nav className="w-full fixed z-40">
            ...
            <div className="px-4 md:px-16 py-6 flex flex-row items-center transition duration-500" style={{ backgroundImage: showBackground ? 'linear-gradient(to bottom, #090909 20%, #141414)' : '' }}>
